...
namespace inoutBoundary {
	...
	void outletPressure() {
		...
		N[nx - 1][2][5] = N[nx - 1][2][7] = 0.5 * (rhoInlet - (N[nx - 1][2][0] + N[nx - 1][2][1] + N[nx - 1][2][2] + N[nx - 1][2][3] + N[nx - 1][2][4] + N[nx - 1][2][6] + N[nx - 1][2][8]));

		N[nx - 1][ny - 3][3] = N[nx - 1][ny - 3][1]; N[nx - 1][ny - 3][4] = N[nx - 1][ny - 3][2]; N[nx - 1][ny - 3][7] = N[nx - 1][ny - 3][5];
		N[nx - 1][ny - 3][6] = N[nx - 1][ny - 3][8] = 0.5 * (rhoInlet - (N[nx - 1][ny - 3][0] + N[nx - 1][ny - 3][1] + N[nx - 1][ny - 3][2] + N[nx - 1][ny - 3][3] + N[nx - 1][ny - 3][4] + N[nx - 1][ny - 3][5] + N[nx - 1][ny - 3][7]));
